...
INSERT INTO `categoria` VALUES (1,'informatica'),(2,'escritorio'),(3,'a1'),(4,'a2'),(5,'a3'),(6,'a4'),(7,'a5'),(8,'a6');
...
CREATE TABLE `cliente` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cpf_ou_cnpjm` varchar(255) DEFAULT NULL,
...
INSERT INTO `cliente` VALUES (1,'2135597213','maria.silva@gmail.com','Maria Silva',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','23131','Apto 300','Rua flores','300',1,1),(2,'Rotunda','244','Apto 100','Rua Carpacio','1200',2,1);
...
CREATE TABLE `item_pedido` (
  ...
  KEY `FKlbt2cf9ngl8qxqenehgl2617c` (`producto_id`)
...
INSERT INTO `item_pedido` VALUES (0,2000,1,1,1),(0,80,2,3,1),(100,800,1,2,2);
...
INSERT INTO `producto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de escritorio',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV',1200),(8,'Roçadeira',800),(9,'Abajour',100),(10,'Pendente',180),(11,'Shampo',90);
...
INSERT INTO `producto_categoria` VALUES (1,1),(1,4),(2,1),(2,2),(2,4),(3,1),(3,4),(4,2),(5,3),(6,3),(7,4),(8,5),(9,6),(10,6),(11,7);
...
INSERT INTO `telefone` VALUES (1,'21331123'),(1,'21982313');
...
-- Dump completed on 2018-05-01 12:03:06
